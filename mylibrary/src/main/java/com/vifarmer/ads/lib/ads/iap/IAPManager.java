...
public class IAPManager {
    ...
    private void showProductsAvailableToBuy(ArrayList<QueryProductDetailsParams.Product> listIAPProduct, ArrayList<QueryProductDetailsParams.Product> listSubProduct) {
        if (!listIAPProduct.isEmpty()) {
            ...
            billingClient.queryProductDetailsAsync(queryProductDetailsParamsIAP, (billingResult, queryProductDetailsResult) -> {
                // check billingResult
                // process returned productDetailsList
                productDetailsListIAP = queryProductDetailsResult.getProductDetailsList();
                addProductDetailsINAPToMap(queryProductDetailsResult.getProductDetailsList());
            });
        }
        if (!listSubProduct.isEmpty()) {
            ...
            billingClient.queryProductDetailsAsync(queryProductDetailsParamsSub, (billingResult, queryProductDetailsResult) -> {
                // check billingResult
                // process returned productDetailsList
                productDetailsListSub = queryProductDetailsResult.getProductDetailsList();
                addProductDetailsSubsToMap(queryProductDetailsResult.getProductDetailsList());
            });
        }
    }
